...
> [← VLA 调研报告](/vla/) · **33 篇细读**(按范式,亦见侧栏):级联·显式 [UniPi](/wam/papers/unipi)·[Gen2Act](/wam/papers/gen2act)·[Veo-Act](/wam/papers/veo-act) ｜ 级联·隐式 [VPP](/wam/papers/vpp)·[LAPA](/wam/papers/lapa)·[DexWorldModel](/wam/papers/dexworldmodel) ｜ 联合·自回归 [GR-1](/wam/papers/gr-1)·[WorldVLA](/wam/papers/worldvla)·[RynnVLA-002](/wam/papers/rynnvla-002) ｜ 联合·扩散 [UWM](/wam/papers/uwm)·[DreamZero](/wam/papers/dreamzero)·[X-WAM](/wam/papers/x-wam)·[LingBot-VA](/wam/papers/lingbot-va)·[τ0-WM](/wam/papers/tau0-wm)·[GR00T N2](/wam/papers/groot-n2)·[LaDi-WM](/wam/papers/ladi-wm)·[WALL-WM](/wam/papers/wall-wm)·[GigaWorld-Policy](/wam/papers/gigaworld-policy)·[WAV](/wam/papers/wav)·[MotuBrain](/wam/papers/motubrain)·[MotionWAM](/wam/papers/motionwam) ｜ 联合·混合 [UVA](/wam/papers/uva)·[FLARE](/wam/papers/flare)·[OA-WAM](/wam/papers/oa-wam)·[HiMem-WAM](/wam/papers/himem-wam)·[NavWM](/wam/papers/navwm)·[ω-EVA](/wam/papers/omega-eva) ｜ 基座/平台/仿真 [Cosmos 3](/wam/papers/cosmos3)·[Qwen-RobotWorld](/wam/papers/qwen-robotworld)·[Genie Envisioner](/wam/papers/genie-envisioner)·[GE-Sim 2.0](/wam/papers/ge-sim-2)·[RoboDream](/wam/papers/robodream)·[World Value Models](/wam/papers/world-value-models)
...
[![GPT-IMAGE2 生成的 WAM 分类图:从观测、未来状态预测到动作输出,下分级联、联合自回归、联合扩散、潜空间规划与世界仿真五条路线](/figures/wam-taxonomy-gpt-image2.png)](/figures/wam-taxonomy-gpt-image2.png)

*读图方式:上层是 WAM 的基本闭环——观测 → 未来状态预测 → 动作;下层把方法按预测与动作的耦合方式拆成五类:级联、联合自回归、联合扩散、潜空间规划与世界仿真/平台。*
