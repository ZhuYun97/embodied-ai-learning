...
## 5.4 其他动向(证据较薄,暂未单列细读)

- **GR00T N1.6 / N1.7**:NVIDIA 持续迭代(N1.7 为当前 3B 主力),详见 [GR00T 细读](papers/groot-n1.md) 的演进小节。
