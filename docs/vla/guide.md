...
- **是**:对 VLA 领域(2022–2026)的体系化梳理——发展脉络、23 篇核心论文细读、横切分析专题、数据/基准/机器人本体专题,附可信度标注与一手信源。
...
- **横切/数据**:[全模型规格对比大表](papers/models-spec)(一页看全 23 模型)· [双系统架构原理](papers/dual-system-architecture) · [具身数据全景](papers/embodied-data)
...
- **论文细读 ×23** — 奠基与两条路线(11)+ 2025H2–2026 前沿(7:含 Wall-OSS-0.5)+ 更多代表模型(5:RDT-1B/GO-1/MemoryVLA/SpatialVLA/Helix)
- **横切分析专题 ×5** — 全模型规格对比 / 双系统架构原理 / 推理加速与部署 / 开源代码库对照 / 共性失败模式
