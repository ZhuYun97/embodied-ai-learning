...
- **是**:对 VLA 领域(2022–2026)的体系化梳理——发展脉络、22 篇核心论文细读、横切分析专题、数据/基准/机器人本体专题,附可信度标注与一手信源。
...
- **论文细读 ×22** — 奠基与两条路线(11)+ 2025H2–2026 前沿(6)+ 更多代表模型(5:RDT-1B/GO-1/MemoryVLA/SpatialVLA/Helix)
