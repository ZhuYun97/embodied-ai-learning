...
[![GPT-IMAGE2 生成的双系统架构图:慢速语义推理模块通过窄接口连接高速连续控制模块](/figures/dual-system-cover-gpt-image2.jpg)](/figures/dual-system-cover-gpt-image2.jpg)

*读图方式:慢系统承载语义和任务理解,快系统承载高频连续控制;中间接口可以是隐向量、子任务、动作先验或梯度隔离。*
