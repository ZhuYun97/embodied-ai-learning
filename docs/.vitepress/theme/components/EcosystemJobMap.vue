...
const CITY_BY_ID = {
  ...
  'intrinsic': 'mountainview',
  'amazon-robotics': 'northreading',
  'neura-robotics': 'metzingen',
  'anybotics': 'zurich',
  'engineered-arts': 'falmouth',
  'mujin': 'tokyo',
  'robust-ai': 'sancarlos',
  'graymatter': 'carson',
  'nimble': 'sf',
  'standard-bots': 'glencove',
  'paxini': 'shenzhen',
  'astribot': 'shenzhen',
  'magiclab': 'wuxi',
  'xpeng-robotics': 'guangzhou',
  'pudu': 'shenzhen',
  'syrius': 'shenzhen',
  'standard-robots': 'shenzhen',
  'realman': 'beijing',
  'rokae': 'jining',
  'megarobo': 'beijing',
  'aubo': 'beijing',
  'elephant-robotics': 'shenzhen',
  'agilex': 'shenzhen',
  'hiwonder': 'shenzhen',
  'siasun': 'shenyang',
}
...
const CITY_META = {
  ...
  mountainview: { label: 'Mountain View, CA', lat: 37.3861, lng: -122.0839, region: 'intl' },
  northreading: { label: 'North Reading, MA', lat: 42.5751, lng: -71.0787, region: 'intl' },
  metzingen:  { label: 'Metzingen, Germany', lat: 48.5369, lng: 9.2833, region: 'intl' },
  zurich:     { label: 'Zurich', lat: 47.3769, lng: 8.5417, region: 'intl' },
  falmouth:   { label: 'Falmouth, UK', lat: 50.1520, lng: -5.0663, region: 'intl' },
  tokyo:      { label: 'Tokyo', lat: 35.6762, lng: 139.6503, region: 'intl' },
  carson:     { label: 'Carson, CA', lat: 33.8317, lng: -118.2820, region: 'intl' },
  glencove:   { label: 'Glen Cove, NY', lat: 40.8623, lng: -73.6337, region: 'intl' },
  guangzhou:  { label: '广州', lat: 23.1291, lng: 113.2644, region: 'china' },
  wuxi:       { label: '无锡', lat: 31.4912, lng: 120.3119, region: 'china' },
  jining:     { label: '济宁', lat: 35.4154, lng: 116.5872, region: 'china' },
  shenyang:   { label: '沈阳', lat: 41.8057, lng: 123.4315, region: 'china' },
}
