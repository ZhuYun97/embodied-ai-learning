...
/* ============================================================
   科技皮:新闻卡片 → 深空 HUD 卡(与底部控制台 / 生态图谱统一)
   仅改卡片内部(卡内变量级联),工具栏 / 统计 / 日期标题保持原样可读
   ============================================================ */
:global(html:not(.skin-archive)) .news-card {
  --vp-c-text-1: #eaf2ff;
  --vp-c-text-2: rgba(205, 216, 240, 0.80);
  --vp-c-text-3: rgba(150, 165, 205, 0.62);
  --vp-c-divider: rgba(56, 189, 248, 0.16);
  --vp-c-default-soft: rgba(148, 163, 184, 0.16);
  --vp-c-brand-1: #5cc8ff;
  --vp-c-brand-2: #38bdf8;
  --vp-c-brand-soft: rgba(34, 211, 238, 0.18);
  --vp-c-brand-softer: rgba(34, 211, 238, 0.10);
  --tech-card-bg: linear-gradient(180deg, #0b1228 0%, #080d1e 100%);
  border-color: rgba(56, 189, 248, 0.2);
  box-shadow: inset 0 0 26px rgba(34, 211, 238, 0.04);
}
/* 电路网格:青色、更清晰 */
:global(html:not(.skin-archive)) .news-card::after {
  background-image:
...
/* 顶部重要程度色条:发光 */
:global(html:not(.skin-archive)) .news-card[data-importance="hot"]::before { box-shadow: 0 0 12px rgba(239, 68, 68, 0.85); }
:global(html:not(.skin-archive)) .news-card[data-importance="major"]::before { box-shadow: 0 0 12px rgba(245, 158, 11, 0.75); }
:global(html:not(.skin-archive)) .news-card[data-importance="normal"]::before { box-shadow: 0 0 10px rgba(148, 163, 184, 0.6); }
/* 悬停:霓虹辉光 */
:global(html:not(.skin-archive)) .news-card:hover {
  border-color: rgba(56, 189, 248, 0.55);
  box-shadow:
    0 0 0 1px rgba(56, 189, 248, 0.4),
    inset 0 0 26px rgba(34, 211, 238, 0.07),
    0 18px 48px -18px rgba(34, 211, 238, 0.5);
}
/* 徽章:深底霓虹发光 */
:global(html:not(.skin-archive)) .news-card .news-badge--hot { background: rgba(239, 68, 68, 0.18); color: #fca5a5; box-shadow: 0 0 12px -3px rgba(239, 68, 68, 0.65); }
:global(html:not(.skin-archive)) .news-card .news-badge--major { background: rgba(245, 158, 11, 0.18); color: #fcd34d; box-shadow: 0 0 12px -3px rgba(245, 158, 11, 0.65); }
:global(html:not(.skin-archive)) .news-card .news-badge--normal { background: rgba(148, 163, 184, 0.18); color: #cbd5e1; }
:global(html:not(.skin-archive)) .news-card .news-badge--verified { background: rgba(34, 197, 94, 0.18); color: #86efac; box-shadow: 0 0 12px -3px rgba(34, 197, 94, 0.6); }
:global(html:not(.skin-archive)) .news-card .news-badge--todo { background: rgba(234, 179, 8, 0.18); color: #fde047; }
:global(html:not(.skin-archive)) .news-card .news-badge--bot { background: rgba(139, 92, 246, 0.2); color: #c4b5fd; }
/* 类别标签:细青边,HUD 感 */
:global(html:not(.skin-archive)) .news-card .news-tag { border: 1px solid rgba(56, 189, 248, 0.16); }
/* 相关阅读 chip */
:global(html:not(.skin-archive)) .news-card .related-link { background: rgba(34, 211, 238, 0.1); }
</style>
