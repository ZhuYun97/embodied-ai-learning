...
<div class="paper-status-strip" aria-label="状态说明">
  <span class="paper-status paper-status--done">已细读</span>
  <span class="paper-status paper-status--todo">待细读</span>
  <span class="paper-status paper-status--watch">观察</span>
